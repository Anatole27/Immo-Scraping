...
public class LbcScraper extends WebScraper {
	...
	private static final String BASE_SEARCH_URL = "https://www.leboncoin.fr/recherche/?category=9&regions=16&location=Toulouse_31400,Toulouse_31500&real_estate_type=2,1&square=min-140&page=";
	private static final String AD_HREF_REGEX ="(?<=clearfix trackable\" href=\")/ventes_immobilieres/[0-9]*.htm/";
